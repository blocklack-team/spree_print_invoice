Rails.application.config.after_initialize do
  ...
  items = [
  	Spree::Admin::MainMenu::ItemBuilder.new(Spree.t(:invoices), Spree::Core::Engine.routes.url_helpers.admin_bookkeeping_documents_path(q: { template_eq: 'invoice' })).build,
    Spree::Admin::MainMenu::ItemBuilder.new(Spree.t(:packaging_slips), Spree::Core::Engine.routes.url_helpers.admin_bookkeeping_documents_path(q: { template_eq: 'packaging_slip' })).build
  ]
